...
export default class NewBill {
  ...
  handleChangeFile = e => {
    ...
    this.removeError(this.document.querySelector(`input[data-testid="file"]`));
  
   
    formData.append('file', file)
    formData.append('email', email)

    // Testing file uploaded
    ...
    {
      this.inputError(this.document.querySelector(`input[data-testid="file"]`));
    }
  }
